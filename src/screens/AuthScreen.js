		...
		return (
			<View>
				<View style={{ marginBottom: 10 }}>
					...
					<FormInput placeholder="jon@email.com" value={this.props.email} onChangeText={this.onEmailChange} />
				</View>
				...
				<FormValidationMessage containerStyle={{ marginBottom: 10 }}>{this.props.error}</FormValidationMessage>
