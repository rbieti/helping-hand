...
const SLIDE_DATA = [
  { text: "Welcome to Helping Hand.", color: PRIMARY_COLOR },
  { text: "An app that willl help you stay on task", color: SECONDARY_COLOR },
  { text: "Designed for healthcare professionals", color: PRIMARY_COLOR }
];
